package com.mars.server.http.request;

import com.mars.server.http.constant.MartianServerConstant;
import com.mars.server.http.model.HttpHeaders;
import com.mars.server.http.model.RequestURI;
...
public class MartianHttpExchange {
    ...
    public String getContentType(){
        String contentType = requestHeaders.get(MartianServerConstant.CONTENT_TYPE);
        if(contentType == null){
            contentType = requestHeaders.get(MartianServerConstant.CONTENT_TYPE_LOW);
        }
        return contentType;
    }
    ...
    public long getRequestContentLength(){
        ...
        if(contentLength == null){
            contentLength = requestHeaders.get(MartianServerConstant.CONTENT_LENGTH_LOW);
        }
